package com.rutvik.mytranslator;
...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguage = {"From", "English", "Gujarati", "Afrikaans", "Arabic", "Belarusian", "Bulgarian", "Bengali", "Catalan", "Czech", "Welsh", "Hindi", "Urdu"};
    String[] toLanguage = {"To", "English", "Gujarati", "Afrikaans", "Arabic", "Belarusian", "Bulgarian", "Bengali", "Catalan", "Czech", "Welsh", "Hindi", "Urdu"};
